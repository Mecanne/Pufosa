...
<body>
    ...
    //Mensajes de confirmacion
        ...
        if(isset($_REQUEST['añadido'])){
            if($_REQUEST['añadido'] == 1) echo '<div class="container alert alert-success" id="añadir">¡Cliente <strong>añadido</strong> con exito!</div>';
            else echo '<div class="container alert alert-danger" id="añadir">No se ha podido añadir el cliente.</div>';
            ?>
        ...
        if(isset($_REQUEST['borrado'])){
            if($_REQUEST['borrado'] == 1) echo '<div class="container alert alert-success" id="borrar">¡Cliente <strong>borrado</strong> con exito!</div>';
            else echo '<div class="container alert alert-danger" id="añadir">No se ha podido borrar el cliente.</div>';
            ?>
